...
import com.app.avy.module.Reminder
import com.app.avy.utils.Constant.CALDAV
import com.app.avy.utils.Constant.DAY
import com.app.avy.utils.Constant.FLAG_ALL_DAY
import com.app.avy.utils.Constant.FLAG_IS_PAST_EVENT
import com.app.avy.utils.Constant.MONTH
import com.app.avy.utils.Constant.REGULAR_EVENT_TYPE_ID
import com.app.avy.utils.Constant.REMINDER_NOTIFICATION
import com.app.avy.utils.Constant.REMINDER_OFF
import com.app.avy.utils.Constant.REPEAT_ORDER_WEEKDAY
import com.app.avy.utils.Constant.REPEAT_ORDER_WEEKDAY_USE_LAST
import com.app.avy.utils.Constant.REPEAT_SAME_DAY
import com.app.avy.utils.Constant.SOURCE_SIMPLE_CALENDAR
import com.app.avy.utils.Constant.WEEK
import com.app.avy.utils.Constant.YEAR
import com.app.avy.utils.Constant.getNowSeconds
...
data class Event(
    ...
    var isPastEvent: Boolean
        ...
        set(isPastEvent) {
            flags = addBitIf(isPastEvent, FLAG_IS_PAST_EVENT)
        }

    var color: Int = 0

    fun addBitIf(add: Boolean, bit: Int) =
        if (add) {
            addBit(bit)
        } else {
            removeBit(bit)
    ...
    fun addBit(bit: Int) = bit

    fun removeBit(bit: Int) = addBit(bit) - bit
