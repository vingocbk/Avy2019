package com.app.avy.ui.view.autoscroll;
...
public class ViewPagerIndicator extends LinearLayoutCompat {
    ...
    public void setupWithViewPager(@NonNull final ViewPager viewPager, int count) {
    ...
    private class OnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(final int position) {
            if (position % mPageCount == 0) {
                setSelectedIndex(mPageCount - 1);
            } else {
                setSelectedIndex(position % mPageCount - 1);
            }
