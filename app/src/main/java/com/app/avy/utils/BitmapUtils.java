...
public final class BitmapUtils {
    ...
    public static Bitmap convertDrawable(@NonNull final Resources resources,
        ...
        final int iconSize = resources.getDimensionPixelSize(R.dimen.icon_with_48dp);
    ...
    public static Bitmap createToolbarIcon(@NonNull Resources resources,
        ...
        final int padding = resources.getDimensionPixelSize(R.dimen.padding_8dp);
        final int iconSize = resources.getDimensionPixelSize(R.dimen.icon_with_24dp);
