...
object Formatter {
    ...
    fun getHourPattern(context: Context) = if (Config.newInstance(context).use24HourFormat) PATTERN_HOURS_24 else PATTERN_HOURS_12

    fun getTimePattern(context: Context) = if (Config.newInstance(context).use24HourFormat) PATTERN_TIME_24 else PATTERN_TIME_12
